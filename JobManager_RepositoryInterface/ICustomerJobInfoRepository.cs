...
namespace JobManager_RepositoryInterface
{
    public interface ICustomerJobInfoRepository
    {
        ...
        bool UpdateCustomerJobInfo(Expression<Func<customer_quartzjobinfo, customer_quartzjobinfo>> cloums, Expression<Func<customer_quartzjobinfo, bool>> whereExpression);
        ...
        (List<customer_quartzjobinfo>, int) LoadCustomerInfoes(Expression<Func<customer_quartzjobinfo, bool>> whereExpression, Expression<Func<customer_quartzjobinfo, object>> orderByExpression, bool isAsc, int pageIndex, int pageSize);
        /// <summary>
        /// 加载单个任务
        /// </summary>
        /// <param name="id">任务主键编号</param>
        /// <returns>单个任务信息</returns>
        customer_quartzjobinfo LoadCustomerInfo(int id);
    }
}
