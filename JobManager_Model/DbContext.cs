...
namespace JobManager_Model
{
    public class DbContext
    {
        ...
        public DbContext()
        {
            Db = new SqlSugarClient(new ConnectionConfig { ConnectionString = @"server=xxx;userid=xxx;password=xxxx;persistsecurityinfo=True;database=xxx", DbType = DbType.MySql, IsAutoCloseConnection = true, InitKeyType = InitKeyType.SystemTable });
        }
        public DbSet<customer_quartzjobinfo> customer_quartzjobinfoDb { get { return new DbSet<customer_quartzjobinfo>(Db); } }
