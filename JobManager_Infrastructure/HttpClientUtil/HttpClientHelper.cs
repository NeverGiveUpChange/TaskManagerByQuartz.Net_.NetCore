...
using JobManager_Infrastructure.RsaCryptionUtil;

namespace JobManager_Infrastructure.HttpClientUtil
{
    public class HttpClientHelper
    {
        ...
        static HttpClientHelper()
        {
            ...
            //HttpClient预热
            _httpClient.SendAsync(new HttpRequestMessage { Method = new HttpMethod("HEAD"), RequestUri = new Uri("https://www.baidu.com/") }).Result.EnsureSuccessStatusCode();
        }
        ...
        {
            return $"expiry{expiry}timestamp{timestamp}{requestParameters}".RSAEncrypt(Encoding.UTF8.GetString(Convert.FromBase64String("")));// ConfigurationManager.AppSettings["PlatformPrivateKey_Web"]
        }
